...
def train_FIA(dataloader,epochs,steps_per_epoch,classifier,MAE_model=None,filename="MAE_FIA.pth",
...
if __name__ == "__main__":
    ...
    train_FIA(dataloader,100,50,classifier,MAE_model,F_args = F_args,freeze_encoder=True)
